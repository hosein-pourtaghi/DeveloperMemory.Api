...
public class EmbeddingRebuildServiceTests
{
    ...
    [Fact]
    public async Task RebuildAsync_Success_ReturnsSuccess()
    {
        ...
        _vectorStoreMock.Verify(v => v.DeleteAsync(memoryId, It.IsAny<CancellationToken>()), Times.Once);
        _vectorStoreMock.Verify(v => v.UpsertAsync(memoryId, It.IsAny<Embedding>(), It.IsAny<CancellationToken>()), Times.Once);
    }
