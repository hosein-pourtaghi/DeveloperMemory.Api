...
public interface IMemoryRepository
{
    ...
    Task<List<MemoryEntry>> GetByScopeAsync(MemoryScope scope, Guid? projectId = null, CancellationToken ct = default);
    Task<List<MemoryEntry>> SearchAsync(string query, MemoryScope? scope = null, Guid? projectId = null, CancellationToken ct = default);
    ...
    Task<int> CountAsync(MemoryScope? scope = null, Guid? projectId = null, CancellationToken ct = default);
}
