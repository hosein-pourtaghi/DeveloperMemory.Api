...
public class LlmConflictDetectorTests
{
    ...
    {
        _deterministicDetector = new MemoryConflictDetector(_deterministicLoggerMock.Object);
    ...
    [Fact]
    public async Task DetectConflictsAsync_Cancellation_Throws()
    {
        var detector = new LlmConflictDetector(
            _deterministicDetector,
            _httpClientFactoryMock.Object,
        ...
        await Assert.ThrowsAsync<OperationCanceledException>(
            () => detector.DetectConflictsAsync(candidate, [], cts.Token));
    }
