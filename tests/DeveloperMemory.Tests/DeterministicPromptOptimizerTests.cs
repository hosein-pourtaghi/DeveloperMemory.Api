...
{
    private readonly DeterministicPromptOptimizer _optimizer = new();
    ...
    [Fact]
    public void Optimize_NullString_ReturnsEmpty()
    {
        Assert.Equal(string.Empty, _optimizer.Optimize(null!));
    }
    ...
    [Fact]
    public void Optimize_RemovesTrailingWhitespace()
    {
        var input = "Line with trailing spaces   \nAnother line\t\t";
        var result = _optimizer.Optimize(input);
    ...
    [Fact]
    public void Optimize_NormalizesLineEndings()
    {
        var input = "Line 1\r\nLine 2\rLine 3";
        var result = _optimizer.Optimize(input);
