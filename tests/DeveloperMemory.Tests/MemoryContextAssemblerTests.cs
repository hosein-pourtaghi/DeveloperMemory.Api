...
public class MemoryContextAssemblerTests
{
    ...
    [Fact]
    public void Assemble_DetectsVersionContradictions()
    {
        var context = new PromptContext
        {
            RetrievedMemories =
            [
                new RetrievedMemory
                {
                    ...
                    Content = "Use .NET 8 for the project",
                    Scope = MemoryScope.Project,
                    Importance = 0.8,
                ...
                new RetrievedMemory
                {
                    ...
                    Content = "Use .NET 10 for the project",
                    Scope = MemoryScope.Project,
                    Importance = 0.9,
                    UpdatedAt = DateTime.UtcNow
                }
        ...
        Assert.True(result.Contradictions.Count > 0);
        Assert.Contains(result.Contradictions, c => c.Description.Contains("Version"));
    }

    [Fact]
    public void Assemble_ContradictionPrefersNewerMemory()
    {
        ...
        Assert.Contains(result.Contradictions, c => c.PreferredMemoryId == id2);
    }
