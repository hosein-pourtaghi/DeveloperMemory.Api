...
public class DeterministicPromptAnalyzerTests
{
    ...
    [Fact]
    public void Analyze_CodingRequest_DetectsCodingIntent()
    {
        var result = _analyzer.Analyze("Implement a new authentication service");
    ...
    [Fact]
    public void Analyze_ExplanationRequest_DetectsExplanationIntent()
    {
        var result = _analyzer.Analyze("Explain why this query is slow");

        Assert.Equal(IntentType.Explanation, result.Intent);
        Assert.Equal(TaskType.Explanation, result.TaskType);
    }
    ...
    [Fact]
    public void Analyze_ExtractsKeywords()
    {
        var result = _analyzer.Analyze("Implement a new authentication service using JWT tokens");

        Assert.NotEmpty(result.Keywords);
        Assert.Contains("authentication", result.Keywords);
    }
